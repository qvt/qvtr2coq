...
public class UmlMMSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UmlMMPackage.PACKAGE: {
				umlMM_.Package package_ = (umlMM_.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlMMPackage.CLASS: {
				umlMM_.Class class_ = (umlMM_.Class)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(umlMM_.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(umlMM_.Class object) {
		return null;
	}
