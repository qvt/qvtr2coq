...
public class UmlMMPackageImpl extends EPackageImpl implements UmlMMPackage {
	 ...
	 * @see umlMM_.UmlMMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getPackage_Dummy() {
	...
	public void createPackageContents() {
		...
		createEReference(packageEClass, PACKAGE__DUMMY);
	...
	public void initializePackageContents() {
		...
		initEClass(packageEClass, umlMM_.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPackage_Name(), ecorePackage.getEString(), "name", null, 1, 1, umlMM_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Classifier(), this.getClassifier(), this.getClassifier_Namespace(), "classifier", null, 1, -1, umlMM_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Association(), this.getAssociation(), this.getAssociation_Namespace(), "association", null, 1, -1, umlMM_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Dummy(), this.getdummy(), this.getdummy_ContainsPackage(), "dummy", null, 1, 1, umlMM_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classEClass, umlMM_.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Kind(), this.getKIND(), "kind", null, 1, 1, umlMM_.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_Attribute(), this.getAttribute(), this.getAttribute_Owner(), "attribute", null, 1, -1, umlMM_.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_General(), this.getClass_(), this.getClass_Subclass(), "general", null, 1, 1, umlMM_.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_Subclass(), this.getClass_(), this.getClass_General(), "subclass", null, 1, -1, umlMM_.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_SourceOf(), this.getAssociation(), this.getAssociation_Source(), "sourceOf", null, 1, -1, umlMM_.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_DestinationOf(), this.getAssociation(), this.getAssociation_Destination(), "destinationOf", null, 1, -1, umlMM_.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getdummy_ContainsPackage(), this.getPackage(), this.getPackage_Dummy(), "containsPackage", null, 1, -1, dummy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(kindEEnum, umlMM_.KIND.class, "KIND");
		addEEnumLiteral(kindEEnum, umlMM_.KIND.PERSISTENT);
		addEEnumLiteral(kindEEnum, umlMM_.KIND.OTHER);
