...
public class UMLecore2UMLdtdTransformer extends AbstractWorkflowComponent2 {
	private String inputSlot;
	private String outputSlot;
	
	private final Map<String, String> config;
	
	public UMLecore2UMLdtdTransformer() {
		...
		if (inputSlotContent == null) {
			...
			for (Object element : (Collection<?>) inputSlotContent) {
				if (element instanceof /*uml.UML*/EObject) {
					...
					/*umlMM.dummy*/EObject transformedModel = new UMLecore2UMLdtd().transform(inputModel, config);
