 ...
 * <!-- end-user-doc -->
 * @see umlMM.UmlMMPackage
 * @generated
 */
public class UmlMMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UmlMMPackage.PACKAGE: {
				umlMM.Package package_ = (umlMM.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlMMPackage.CLASS: {
				umlMM.Class class_ = (umlMM.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = caseClassifier(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlMMPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlMMPackage.CLASSIFIER: {
				Classifier classifier = (Classifier)theEObject;
				T result = caseClassifier(classifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlMMPackage.PRIMITIVE_DATA_TYPE: {
			...
			case UmlMMPackage.ASSOCIATION: {
				Association association = (Association)theEObject;
				T result = caseAssociation(association);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlMMPackage.DUMMY: {
	 ...
	 * @generated
	 */
	public T caseClass(umlMM.Class object) {
		return null;
	}
