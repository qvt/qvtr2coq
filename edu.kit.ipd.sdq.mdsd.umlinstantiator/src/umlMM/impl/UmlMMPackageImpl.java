...
import umlMM.PrimitiveDataType;
...
public class UmlMMPackageImpl extends EPackageImpl implements UmlMMPackage {
	 ...
	 * @generated
	 */
	public EReference getAssociation_Namespace() {
	 ...
	 * @generated
	 */
	public EReference getdummy_ContainsPackage() {
	...
	public void createPackageContents() {
		...
		createEAttribute(classEClass, CLASS__KIND);
		...
		createEReference(associationEClass, ASSOCIATION__NAMESPACE);
		...
		createEReference(dummyEClass, DUMMY__CONTAINS_PACKAGE);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPackage_Name(), ecorePackage.getEString(), "name", null, 1, 1, umlMM.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Classifier(), this.getClassifier(), this.getClassifier_Namespace(), "classifier", null, 1, -1, umlMM.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Association(), this.getAssociation(), this.getAssociation_Namespace(), "association", null, 1, -1, umlMM.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(classEClass, umlMM.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Kind(), ecorePackage.getEString(), "kind", null, 1, 1, umlMM.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_Attribute(), this.getAttribute(), this.getAttribute_Owner(), "attribute", null, 1, -1, umlMM.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_General(), this.getClass_(), this.getClass_Subclass(), "general", null, 1, 1, umlMM.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_Subclass(), this.getClass_(), this.getClass_General(), "subclass", null, 1, -1, umlMM.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_SourceOf(), this.getAssociation(), this.getAssociation_Source(), "sourceOf", null, 1, -1, umlMM.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_DestinationOf(), this.getAssociation(), this.getAssociation_Destination(), "destinationOf", null, 1, -1, umlMM.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getAssociation_Namespace(), this.getPackage(), this.getPackage_Association(), "namespace", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_Source(), this.getClass_(), this.getClass_SourceOf(), "source", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_Destination(), this.getClass_(), this.getClass_DestinationOf(), "destination", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(dummyEClass, dummy.class, "dummy", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getdummy_ContainsPackage(), this.getPackage(), null, "containsPackage", null, 1, -1, dummy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
