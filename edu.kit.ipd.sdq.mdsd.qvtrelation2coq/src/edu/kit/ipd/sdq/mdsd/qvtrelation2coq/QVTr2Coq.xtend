...
// TODO: remove explicit check in source/target domains that a domainÕs root variable is contained in AllInstances, this is already checked implicitly (transitively).
