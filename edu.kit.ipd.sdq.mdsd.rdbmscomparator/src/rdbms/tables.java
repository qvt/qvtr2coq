 ...
 * <ul>
 *   <li>{@link rdbms.tables#getGroup <em>Group</em>}</li>
 *   <li>{@link rdbms.tables#getTable <em>Table</em>}</li>
 * </ul>
 * </p>
 *
 * @see rdbms.RdbmsPackage#gettables()
...
public interface tables extends EObject {
	 ...
	 * @see rdbms.RdbmsPackage#gettables_Group()
	 ...
	 * @see rdbms.RdbmsPackage#gettables_Table()
